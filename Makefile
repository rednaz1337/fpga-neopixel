...
$(BUILD)/top.config: $(BUILD)/top.json $(SRC)/top.lpf
	nextpnr-ecp5 --25k --timing-allow-fail --package CABGA256 --speed 6 --json $(BUILD)/top.json --lpf $(SRC)/top.lpf --write $(BUILD)/top-post-route.json --textcfg $(BUILD)/top.config
